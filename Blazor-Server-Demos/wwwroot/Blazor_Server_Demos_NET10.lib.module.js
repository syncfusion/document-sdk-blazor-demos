...
const homepagepath = ["/documentprocessing/demos/", "/development/documentprocessing/net10/demos/", "/release/documentprocessing/net10/demos/", "/hotfix/documentprocessing/net10/demos/", "/"];
...
function homePageAssets() {
    ...
    if (data.configuration == "Release") {
        assetFiles = [
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/home-page/fluent2.min.css',
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/common/bootstrap.min.css',
            'https://cdn.syncfusion.com/blazor/sb/favicon.ico',
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/common/site.min.css',
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/common/home.min.css',
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/common/devices.min.css'
        ];
    }
...
function samplePageAssets() {
    ...
    if (data.configuration == "Release") {
        assetFiles = [
            ...
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/common/highlight.min.css',
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/common/demos.min.css',
            'https://cdn.syncfusion.com/blazor/sb/styles/31.1.17/common/devices.min.css',
...
if (homepagepath.indexOf(window.location.pathname) !== -1) {
    ...
    if (data.configuration == "Release") {
        ...
        import("https://cdn.syncfusion.com/blazor/31.1.17/sf-carousel.min.js");
