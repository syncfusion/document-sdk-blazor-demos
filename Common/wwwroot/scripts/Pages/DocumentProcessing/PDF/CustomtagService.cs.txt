...
{ 
    public class CustomtagService
    {
        ...
        public MemoryStream CreatePdfDocument()
        {
            ...
            MemoryStream stream = fileDataValue["noto-sans-regular.ttf"];
            PdfFont fontnormal = new PdfTrueTypeFont(stream, 8.5f);
        ...
        private void PdfGrid_BeginCellLayout(object sender, PdfGridBeginCellLayoutEventArgs args)
        {
            ...
            args.Style.Font = new PdfTrueTypeFont(fileDataValue["noto-sans-regular.ttf"], 8);
