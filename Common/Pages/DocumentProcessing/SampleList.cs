    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> DocIO { get; set; } = new List<Sample>{
			...
			new Sample
            {
                ...
                Directory = "DocumentProcessing/Word",
                Url = "word/create-ink",
                FileName = "CreateInk.razor",
                MetaDescription = "This Blazor Word (DocIO) Library Create Ink sample demonstrates how to create a Word document with Ink using the .NET Word Library (DocIO)",
                NotificationDescription = new string[] { @"Added support for creating, editing, removing, and converting Ink in Word documents (DOCX, DOTX, DOCM, and DOTM)."},
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
            ...
            new Sample			
            {
                ...
                Directory = "DocumentProcessing/Word",
                Url = "word/edit-ink",
                FileName = "EditInk.razor",
                MetaDescription = "This Blazor Word (DocIO) Library Edit Ink sample demonstrates how to modify Ink in a Word document using the .NET Word Library (DocIO)",
                NotificationDescription = new string[]  { @"Added support for creating, editing, removing, and converting Ink in Word documents (DOCX, DOTX, DOCM, and DOTM)."},
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
	    ...
	    new Sample
            ...
            new Sample
            {
                ...
                Category = "Conversion",
                Directory = "DocumentProcessing/PowerPoint",
                Url = "powerpoint/PPTXToMarkdown",
                Type = SampleType.New,
                FileName = "PPTXToMarkdown.razor",
                MetaTitle = "PowerPoint Library - Presentation To Markdown - Syncfusion Demos",
                MetaDescription = "This Blazor PowerPoint Presentation to Markdown sample demonstrates how to convert a PowerPoint presentation to Markdown using the .NET PowerPoint Library.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
                    ...
                    new SourceCollection
                    {
                        Id="PPTXToMarkdownService",
                        FileName="PPTXToMarkdownService.cs"
                    }
                }
            },
            new Sample
            {
                ...
                Category = "Conversion",
                Directory = "DocumentProcessing/PowerPoint",
                Url = "powerpoint/MarkdownToPPTX",
                Type = SampleType.New,
                FileName = "MarkdownToPPTX.razor",
                MetaTitle = "PowerPoint Library - Markdown To Presentation - Syncfusion Demos",
                MetaDescription = "This Blazor PowerPoint Markdown to Presentation sample demonstrates how to convert a Markdown file to a PowerPoint presentation using the .NET PowerPoint Library.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
                    ...
                    new SourceCollection
                    {
                        Id="MarkdownToPPTXService",
                        FileName="MarkdownToPPTXService.cs"
                    }
                }
            }		
        };
        ...
        public List<Sample> XlsIO { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Excel",
                Url = "excel/excel-to-markdown",
                MetaTitle = "Blazor Excel Library - Excel To Markdown - Syncfusion Demos",
                Type = SampleType.New,
                NotificationDescription = new string[]
                {
                    @"This demo showcases the Excel to Markdown feature of the Excel library, enabling users to convert Excel files into Markdown documents while preserving text, numbers, and formulas."
                },
                MetaDescription = "This Blazor Excel to Markdown example demonstrates how to convert the Excel files to Markdown files using Essential Excel (XlsIO). Explore here to more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
                        Id="ExcelToMarkdown",
                        FileName="ExcelToMarkdown.razor"
                    },
                    new SourceCollection
                    {
                        Id="ExcelToMarkdownService.cs",
                        FileName="ExcelToMarkdownService.cs"
                    }
                }
            },
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Excel",
                Url = "excel/markdown-to-excel",
                MetaTitle = "Blazor Excel Library - Markdown To Excel - Syncfusion Demos",
                Type = SampleType.New,
                NotificationDescription = new string[]
                {
                    @"This demo showcases the Markdown to Excel feature of the Excel library, enabling users to convert markdown files into excel documents while preserving text, numbers, and formulas."
                },
                MetaDescription = "This Blazor MArkdown to Excel example demonstrates how to convert the Markdown files to Excel files using Essential Excel (XlsIO). Explore here to more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
                        Id="MarkdownToExcel",
                        FileName="MarkdownToExcel.razor"
                    },
                    new SourceCollection
                    {
                        Id="MarkdownToExcelService",
                        FileName="MarkdownToExcelService.cs"
                    }
                }
            },
#if !WASM && !WEBAPP
        ...
        public List<Sample> Markdown { get; set; } = new List<Sample>{
            new Sample
            {
                Name = "Create Markdown",
                Category = "Getting Started",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/create-markdown",
                Type = SampleType.New,
                FileName = "CreateMarkdown.razor",
                MetaTitle = "Blazor Markdown Library | Create Markdown | Syncfusion",
                MetaDescription = "This Blazor Markdown Library Create Markdown sample demonstrates the create Markdown in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
                    ...
                    new SourceCollection
                    {
                        Id="CreateMarkdownService",
                        FileName="CreateMarkdownService.cs"
                    }
                }
            },
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/word-to-markdown",
                Type = SampleType.New,
                FileName = "WordToMarkdown.razor",
                MetaTitle = "Blazor Markdown Library - Word to Markdown - Syncfusion Demos",
                MetaDescription = "This Blazor Markdown Library Word to Markdown sample demonstrates the Word to Markdown conversion in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
            ...
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/markdown-to-word",
                Type = SampleType.New,
                FileName = "MarkdownToWord.razor",
                MetaTitle = "Blazor Markdown Library - Markdown to Word - Syncfusion Demos",
                MetaDescription = "This Blazor Markdown Library Markdown to Word sample demonstrates the conversion of Markdown to Word document in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
            ...
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/markdown-to-html",
                Type = SampleType.New,
                FileName = "MarkdownToHTML.razor",
                MetaTitle = "Blazor Word (DocIO) Library - Markdown to HTML - Syncfusion Demos",
                MetaDescription = "This Blazor Markdown Library Markdown to HTML sample demonstrates the conversion of Markdown to HTML in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
                    ...
                    new SourceCollection
                    {
                        Id="MarkdownToHTMLService",
                        FileName="MarkdownToHTMLService.cs"
                    }
                }
            },
#if !(WASM) && !WEBAPP
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/markdown-to-pdf",
                Type = SampleType.New,
                FileName = "MarkdownToPDF.razor",
                MetaTitle = "Blazor Markdown Library - Markdown to PDF - Syncfusion Demos",
                MetaDescription = "This Blazor Markdown Library Markdown to PDF sample demonstrates the conversion of Markdown to PDF document in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
                    ...
                    new SourceCollection
                    {
                        Id="MarkdownToPDFService",
                        FileName="MarkdownToPDFService.cs"
                    }
                }
            },
#endif
			new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/PPTXToMarkdown",
                Type = SampleType.New,
                FileName = "PPTXToMarkdown.razor",
                MetaTitle = "Blazor Markdown Library - Presentation To Markdown - Syncfusion Demos",
                MetaDescription = "This Blazor Markdown Library Presentation to Markdown sample demonstrates the Presentation to Markdown conversion in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
            ...
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/MarkdownToPPTX",
                Type = SampleType.New,
                FileName = "MarkdownToPPTX.razor",
                MetaTitle = "Blazor Markdown Library - Markdown To Presentation - Syncfusion Demos",
                MetaDescription = "This Blazor Markdown Library Markdown to Presentation sample demonstrates the Presentation to Markdown conversion in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
            ...
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/excel-to-markdown",
                Type = SampleType.New,
                FileName = "ExcelToMarkdown.razor",
                MetaTitle = "Blazor Markdown Library - Excel To Markdown - Syncfusion Demos",
                NotificationDescription = new string[]
                {
                    @"This demo showcases the Excel to Markdown feature of the Excel library, enabling users to convert Excel files into Markdown documents while preserving text, numbers, and formulas."
                },
                MetaDescription = "This Blazor Markdown Library Excel to Markdown sample demonstrates the Excel to Markdown conversion in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
            ...
            new Sample
            {
                ...
                Category = "Conversions",
                Directory = "DocumentProcessing/Markdown",
                Url = "markdown/markdown-to-excel",
                Type = SampleType.New,
                FileName = "MarkdownToExcel.razor",
                MetaTitle = "Blazor Markdown Library - Markdown To Excel - Syncfusion Demos",
                NotificationDescription = new string[]
                {
                    @"This demo showcases the Markdown to Excel feature of the Excel library, enabling users to convert markdown files into excel documents while preserving text, numbers, and formulas."
                },
                MetaDescription = "This Blazor Markdown Library Markdown to Excel sample demonstrates the Markdown to Excel conversion in the Blazor Markdown Library. Explore here for more details.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
