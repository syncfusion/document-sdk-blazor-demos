...
{
    public class CreateMarkdownService
    {
        private readonly Dictionary<string, MemoryStream> fileDataValue;
        public CreateMarkdownService(Dictionary<string, MemoryStream> fileData)
        {
        ...
        /// </summary>
        /// <returns>Return the created Markdown document as stream</returns>
        public MemoryStream CreateMarkdown()
        {
            ...
            // Create MemoryStream and return it
