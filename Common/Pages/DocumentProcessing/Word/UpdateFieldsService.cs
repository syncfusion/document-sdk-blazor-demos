...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    ...
    {
        #region Fields
        private string m_tradeNo = string.Empty;
        private string m_companyName = string.Empty;
        private string m_costPrice = string.Empty;
        private string m_sharesCount = string.Empty;
        private string m_salesPrice = string.Empty;
        #endregion
        #region Properties
