...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class MailMergeEventService
    {
        ...
        private void MergeField_ProductImage(object sender, MergeImageFieldEventArgs args)
        {
            ...
            if (args.FieldName == "ProductImage")
            {
                ...
                if (!string.IsNullOrEmpty(productFileName) && fileDataValue.ContainsKey(productFileName))
                {
    ...
    {
        #region Fields
        private string m_sNO = string.Empty;
        private string m_productName = string.Empty;
        private string m_productImage = string.Empty;
