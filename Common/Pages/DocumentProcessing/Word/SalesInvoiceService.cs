...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    ...
    public class TestOrderDetail
    {
        ...
        private string m_unitPrice = string.Empty;
        private string m_quantity = string.Empty;
        private string m_discount = string.Empty;
        private string m_extendedPrice = string.Empty;
        #endregion
    ...
    public class TestOrderTotal
    {
        ...
        private string m_orderID = string.Empty;
        private string m_subTotal = string.Empty;
    ...
    public class TestOrder
    {
        ...
        private string m_customersCompanyName = string.Empty;
        private string m_orderDate = string.Empty;
        private string m_requiredDate = string.Empty;
        private string m_shippedDate = string.Empty;
        private string m_shippersCompanyName = string.Empty;
        #endregion
