...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    ...
    public class Employees
    {
        ...
        private string m_birthDate = string.Empty;
        private string m_hireDate = string.Empty;
        ...
        private string m_photo = string.Empty;
        private string m_notes = string.Empty;
        private string m_reportsTo = string.Empty;
        #endregion
        #region Properties
