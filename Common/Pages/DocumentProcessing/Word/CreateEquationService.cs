    ...
    public class CreateEquationService
    {
        ...
        private void CreateTripleScalarProduct(IWParagraph paragraph)
        {
            ...
            if (mathDelimiter != null)
            {
                ...
                if(mathDelimiter.ControlProperties is WCharacterFormat format)
                    format.Italic = true;
        ...
        private IOfficeMathRunElement? AddMathText(WordDocument document, IOfficeMath officeMath, string text)
        {
            ...
            if (officeMathParaItem != null)
            {
                ...
                //Set math text 
                if (officeMathParaItem.Item as WTextRange is WTextRange textRange)
                    textRange.Text = text;
