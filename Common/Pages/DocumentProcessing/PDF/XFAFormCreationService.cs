...
{ 
    public class XFAFormCreationService
    {
        ...
        public MemoryStream CreatePdfDocument()
        {
            ...
            title.Caption = (PdfXfaCaption)caption1.Clone();
            if (title.Caption != null)
            {
            ...
            fn.Caption = (PdfXfaCaption)caption1.Clone();
            if (fn.Caption != null)
            {
            ...
            ln.Caption = (PdfXfaCaption)caption1.Clone();
            if (ln.Caption != null)
            {
            ...
            dob.Caption = (PdfXfaCaption)caption1.Clone();
            if (dob.Caption != null)
            {
            ...
            company.Caption = (PdfXfaCaption)caption1.Clone();
            if (company.Caption != null)
            {
            ...
            jt.Caption = (PdfXfaCaption)caption1.Clone();
            if (jt.Caption != null)
            {
            ...
            jd.Caption = (PdfXfaCaption)caption1.Clone();
            if (jd.Caption != null)
            {
            ...
            st.Caption = (PdfXfaCaption)caption1.Clone();
            if (st.Caption != null)
            {
            ...
            addLine1.Caption = (PdfXfaCaption)caption1.Clone();
            if (addLine1.Caption != null)
            {
            ...
            city.Caption = (PdfXfaCaption)caption1.Clone();
            ...
            state.Caption = (PdfXfaCaption)caption1.Clone();
            ...
            zip.Caption = (PdfXfaCaption)caption1.Clone();
            zip.CombLength = 5;
            if (zip.Caption != null)
            {
            ...
            country.Caption = (PdfXfaCaption)caption1.Clone();
            if (country.Caption != null)
            {
            ...
            email.Caption = (PdfXfaCaption)caption1.Clone();
            if (email.Caption != null)
            {
            ...
            phone.Caption = (PdfXfaCaption)caption1.Clone();
            if (phone.Caption != null)
            {
            ...
            c_email.Caption = (PdfXfaCaption)caption.Clone();
            if (c_email.Caption != null)
            {
            ...
            c_phone.Caption = (PdfXfaCaption)caption.Clone();
            if (c_phone.Caption != null)
            {
            ...
            c_mail.Caption = (PdfXfaCaption)caption.Clone();
            if (c_mail.Caption != null)
            {
            ...
            c_nocontact.Caption = (PdfXfaCaption)caption.Clone();
            if (c_nocontact.Caption != null)
            {
            ...
            r_nonMember.Caption = (PdfXfaCaption)caption.Clone();
            if (r_nonMember.Caption != null)
            {
            ...
            r_member.Caption = (PdfXfaCaption)caption.Clone();
            if (r_member.Caption != null)
            {
            ...
            r_exhibition.Caption = (PdfXfaCaption)caption.Clone();
            if (r_exhibition.Caption != null)
            {
            ...
            r_student.Caption = (PdfXfaCaption)caption.Clone();
            if (r_student.Caption != null)
            {
